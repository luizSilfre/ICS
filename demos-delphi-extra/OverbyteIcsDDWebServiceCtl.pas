...
Sep 13, 2024 V9.3  Tell user why intallation has failed if program does not have admin rights.
Feb 07, 2025 V9.4  Stop server running before sending message to close form.
...
begin
    ...
    if GInstalling then begin     // windows service   V9.3 tell user why it failed
...
begin
    if DDWebServiceSrv <> nil then begin
        ...
        DDWebServiceSrv.StopButtonClick(Self);   { V9.4 }
