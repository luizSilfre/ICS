...
May 20, 2022 V8.69 - Added UploadDir and FIcsMailQueue which are used
                      by URL handlers.
Dec 13, 2022 V8.71 - Removed form, FMX does not like DataModule forms.
                     Descent from TPersistent instead of TDataModule.


 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
unit IcsSslMultiWebDataModule;
...
type
    TSslMultiWebDisplayEvent = procedure (Sender : TObject;
                                        const Msg : String) of object;
//  TSslMultiWebDataModule = class(TDataModule)
    TSslMultiWebDataModule = class(TPersistent)  // FMX
    private
        FIniFileName     : String;
        FDataDir         : String;
        FImagesDir       : String;
