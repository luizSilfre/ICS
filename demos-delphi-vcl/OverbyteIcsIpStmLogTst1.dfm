object IpLogForm: TIpLogForm
  ...
  Top = 84
  Caption = 
    'ICS IP Streaming Log Component Demo -  https://www.overbyte.eu  ' +
    '- 19 Sept 2024'
  ClientHeight = 746
  ClientWidth = 1034
  Color = clBtnFace
    ...
    object SheetSettings: TTabSheet
      ...
      object BoxClient: TGroupBox
        ...
        object Label27: TLabel
          ...
          Width = 91
          Height = 28
          Caption = 'Retry Attempts (-1 none, 0 endless)'
          WordWrap = True
        end
      ...
      object BoxSampleData: TGroupBox
        ...
        object DataUnicode: TCheckBox
          Left = 150
          Top = 60
          Width = 136
          Height = 17
          Caption = 'Test Unicode Data'
          TabOrder = 5
        end
      end
    end
