...
Apr 11, 2024 V9.2 INI file no longer in exe directory but users like all other samples.
...
begin
    FIniFileName  := GetIcsIniFileName;  { V9.2 same as other samples } //  ChangeFileExt(Application.ExeName, '.ini');
    DisplayMemo.Clear;
