object FtpServerForm: TFtpServerForm
  Left = 245
  Top = 305
  Caption = 'ICS Multi FTP Server - https://www.overbyte.eu  - 6 Feb 2024'
  ClientHeight = 600
  ClientWidth = 843
  Color = clBtnFace
  ...
  object ToolsPanel: TPanel
    ...
    object DiagsSslLow: TCheckBox
      Left = 375
      Top = 10
      Width = 206
      Height = 17
      Caption = 'SSL Low Level Diags'
      TabOrder = 3
    end
  end
  ...
  object IcsIpStrmLog2: TIcsIpStrmLog
    MaxSockets = 1
    RemoteIpPort = '514'
    SocFamily = sfIPv4
    LocalIpAddr = '0.0.0.0'
