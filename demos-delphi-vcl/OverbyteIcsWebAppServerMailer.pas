...
Legal issues: Copyright (C) 2009 to 2024 by François PIETTE
...
Feb 06, 2024 V9.1  Added OverbyteIcsCharsetUtils for RemoveHtmlSpecialChars.
                   Using Client.PostedDataStr instead of Client.PostedData to
                     avoid casting a buffer.
Aug 07, 2024 V9.3 Using OverbyteIcsTypes for consolidated types and constants
...
uses
  ...
  {$ENDIF}
    ...
    OverbyteIcsCharsetUtils, OverbyteIcsHtmlUtils,   { V9.1 }
