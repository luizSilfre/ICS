...
Nov 01, 2023 V9.1  Updated Mailer page with PostDataStr.

Note: this is a basic non-SSL server, there are better samples as
OverbyteIcsSslWebServ and OverbyteIcsSslMultiWebServ.
...
{$ENDIF}
  ...
  OverbyteIcsTicks64, OverbyteIcsTypes;    { V8.71 }
