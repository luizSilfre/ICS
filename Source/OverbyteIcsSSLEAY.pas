...
Jul 03, 2023 V8.71 Added OSSL_VER_3100 and OSSL_VER_3200 lits for OpenSSL 3.1 and
...
const
    IcsSSLEAYVersion   = 904;
    CopyRight : String = ' IcsSSLEAY (c) 2003-2025 F. Piette V9.4 ';
...
const
    GSSLEAYImports1: array[0..163] of TOSSLImports = (
