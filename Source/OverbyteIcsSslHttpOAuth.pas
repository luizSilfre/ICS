...
{$ENDIF FMX}
    ...
    OverbyteIcsHtmlUtils,      { V9.1 was FormDecode }
...
const
    THttpOAuthVersion = 904;
    CopyRight : String = ' TSslHttpOAuth (c) 2024 F. Piette V9.4 ';
...
{ property and state types }
  ...
  TOAuthOption = (OAopAuthNoRedir,    { OAuth Auth Request do not send redirect_url }
                  ...
                  OAopAuthBasic);     { OAuth Auth Request use Basic Authentication with client id and secret }
