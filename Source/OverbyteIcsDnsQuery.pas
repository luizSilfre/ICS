...
{$IFDEF COMPILER12_UP}
//    {$IFDEF RTL_NAMESPACES}System.AnsiStrings{$ELSE}AnsiStrings{$ENDIF}, { V9.4 }
{$ENDIF}
{$IFDEF FMX}
    Ics.Fmx.OverbyteIcsWndControl, { V8.71 }
    Ics.Fmx.OverbyteIcsWSocket,
    Ics.Fmx.OverbyteIcsIpUtils,    { V8.71 }
{$ELSE}
    OverbyteIcsWndControl,    { V8.71 }
    OverbyteIcsWSocket,
    OverbyteIcsIpUtils,       { V8.71 }
{$ENDIF}
    OverbyteIcsUtils,
    OverbyteIcsTypes,         { V8.71 }
