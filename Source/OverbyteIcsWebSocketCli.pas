...
{ JK 28.11.2023 end }
                ...
                DataBytes := L;
// JK 28.11.2023                DataBytesInBuf := Size - (SizeOf(TFrameShortMasked) - 1);
            end
...
// JK 28.11.2023                DataBytesInBuf := Size - (SizeOf(TFrameSmallMasked) - 1);
            end
...
// JK 28.11.2023                DataBytesInBuf := Size - (SizeOf(TFrameLargeMasked) - 1);
            end;
...
{ JK 28.11.2023 end }
                ...
                DataBytes := L;
// JK 28.11.2023                DataBytesInBuf := Size - (SizeOf(TFrameShort) - 1);
            end
            else if L = 126 then begin
{ JK 28.11.2023 }
...
// JK 28.11.2023                DataBytesInBuf := Size - (SizeOf(TFrameSmall) - 1);
            end
            else if L = 127 then begin
{ JK 28.11.2023 }
...
// JK 28.11.2023                DataBytesInBuf := Size - (SizeOf(TFrameLarge) - 1);
            end;
